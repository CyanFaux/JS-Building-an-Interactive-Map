...
const polygon = L.polygon(polygonCoords, { color: 'blue', fill: false }).addTo(myMap);
...
const rSRed = L.marker([48.866200610611926, 2.352236247419453],{icon: redPin}).bindPopup('R̩aumur-S̩bastopol')